...
export function Footer() {
  return <footer className="site-footer">
    <div className="footer-cta"><div className="container"><div className="footer-cta-copy"><span className="footer-spark" aria-hidden="true">✦</span><div><h2>Ready to transform education?</h2><p>See how Edora can support your learning ecosystem.</p></div></div><Link className="button button-dark" href="/contact?interest=demo">Request a Demo</Link></div></div>
