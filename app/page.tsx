...
export default function Home() {
  ...
  return <>
    ...
    <section className="hero"><span className="hero-decoration hero-decoration-one" /><span className="hero-decoration hero-decoration-two" /><div className="container hero-grid">
      <div className="hero-copy"><p className="eyebrow">Education technology for every learning ecosystem</p><h1>Powering the <span>Future of Education</span></h1><p>Edora Learning provides one intelligent, secure and adaptable platform for publishers, schools, coaching institutes, academies, educators and learners.</p><div className="button-row"><Link className="button button-primary" href="/contact?interest=demo">Request a Demo <ArrowRight size={18} /></Link><Link className="button button-secondary" href="/platform">Explore the Platform</Link></div><div className="hero-trust"><ShieldCheck aria-hidden="true" /><span>Secure by design</span><span>•</span><span>Built for every education role</span></div></div>
    ...
    <section className="section section-soft-blue audience-section"><div className="container"><SectionHeading eyebrow="Who we serve" title="Built for the Complete Education Ecosystem" description="Purposeful experiences for every organization and person involved in learning." /><div className="grid-3 audience-grid">
      <SolutionCard icon={BookOpen} title="Publishers" description="Digitize books, resources, school relationships and AI-powered content." href="/solutions#publishers" />
      <SolutionCard icon={School} title="Schools" description="Manage academics, educators, students and learning from one place." href="/solutions#schools" />
      <SolutionCard icon={Target} title="Coaching Institutes" description="Organize courses, batches, faculty, assessments and online learning." href="/solutions#coaching" />
      <SolutionCard icon={Building2} title="Academies" description="Launch branded learning programs with mentors, AI and analytics." href="/solutions#academies" />
      <SolutionCard icon={UserRound} title="Educators" description="Access approved resources, teaching tools and intelligent workflows." href="/solutions#educators" />
      <SolutionCard icon={Users} title="Learners and Families" description="Learn, practise, assess progress and receive personalized support." href="/solutions#learners" />
    </div></div></section>
